            ...
            >
              {item.image ? (
                <img
                  src={item.image}
                  alt={item.name}
                  className="h-28 w-full sm:w-28 object-cover bg-neutral-100"
                />
              ) : (
              ...
              <div className="flex-1 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  ...
                  <span className="text-[13px] font-black block mt-1">
                    {fmt(item.price)}
                  </span>
                </div>
                <div className="flex items-center justify-between sm:flex-col sm:items-end gap-2">
                  ...
                  <button
                    className="text-[10px] uppercase font-bold underline text-neutral-500"
        ...
        <div className="lg:col-span-4">
          <div className="border-2 border-black p-5 sticky top-4">
            ...
            <Link
              ...
              className="w-full py-4 mt-5 text-white text-[11px] tracking-[0.2em] uppercase font-black block text-center"
            >
              Proceed to Checkout
            </Link>
          </div>
