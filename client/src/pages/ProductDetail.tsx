    ...
    <PageShell title="" breadcrumb="Home / Electronics / Phones & Tablets">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-6">
          {product.image ? (
            <div className="h-72 md:h-96 bg-neutral-100 overflow-hidden">
              <img
                src={product.image}
                alt={product.name}
        ...
        <div className="md:col-span-6 flex flex-col">
          ...
          <div className="py-5">
            ...
            <div className="flex items-center justify-between mt-2 border border-black/20 p-3">
              <span className="text-[13px] font-semibold">
                Osun, Lagos or Oyo state ▾
              </span>
              <span className="text-[10px] uppercase font-bold underline cursor-pointer">
                Change
              </span>
            </div>
          </div>
          ...
          <div className="py-5 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="flex items-center border-2 border-black w-fit">
              ...
              <span className="px-5 py-3 text-[14px] font-bold border-x-2 border-black">
                {qty}
              </span>
              <button
                className="px-4 py-3 text-[14px] font-black"
